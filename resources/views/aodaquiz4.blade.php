...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 4: People with mobility impairments do not care about how they look.') }}</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <a>Correct! People with disabilities have interests and enjoy different activities like everyone. </a>
                                    
                                </div>
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        <!-- the result to be displayed apply here -->
                                        <a href="aodaquiz5" class="btn btn-primary btn-block">Next Question</a>
