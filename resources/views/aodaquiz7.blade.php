...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 7: When guiding a person who has vision loss, you should always take them by the arm.') }}</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <a>Correct! People who have vision loss may prefer to take your arm when you are guiding them. Ask if they need your assistance first.</a>
                                    
                                </div>
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        <!-- the result to be displayed apply here -->
                                        <a href="aodaquiz8" class="btn btn-primary btn-block">Next Question</a>
