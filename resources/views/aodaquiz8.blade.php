...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 8: Someone who is severely physically disabled cannot do anything alone.') }}</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <a>Correct! There are many helpful aids for people who have physical disabilities which may help them to be more independent..</a>
                                    
                                </div>
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        <!-- the result to be displayed apply here -->
                                        <a href="aodaquiz9" class="btn btn-primary btn-block">Next Question</a>
