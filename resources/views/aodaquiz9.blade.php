...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 9: A person who is Deaf cannot use the phone.') }}</div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                        ...
                                        <a>Correct! There are different systems that allow someone who is Deaf to use the telephone, such as the Teletypewriter (TTY) or a relay system.</a>
                                    
                                </div>
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        <!-- the result to be displayed apply here -->
                                        <a href="aodaquiz10" class="btn btn-primary btn-block">Next Question</a>
