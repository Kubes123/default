...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 12: What Pictogram is this:') }}</div>

                    <div class="flex row justify-content-center pt-8 sm:justify-start sm:pt-0">
                        <img src={{asset('pictogram/flame.gif')}} alt="Logo" height="200" style="padding-top: 21px">
                    </div>
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Corrosive to Skin</b></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz13" class="btn btn-primary btn-block">Next Question</a>
