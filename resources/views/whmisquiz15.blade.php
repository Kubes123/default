...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 15: What Pictogram is this:') }}</div>

                    <div class="flex row justify-content-center pt-8 sm:justify-start sm:pt-0">
                        <img src={{asset('pictogram/skullcrossbones.gif')}} alt="Logo" height="200" style="padding-top: 21px">
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz16" class="btn btn-primary btn-block">Next Question</a>
