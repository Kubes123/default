...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 17: Physical and Chemical Properties on an SDS tells if a product is a solid or gas.') }}</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz18" class="btn btn-primary btn-block">Next Question</a>
