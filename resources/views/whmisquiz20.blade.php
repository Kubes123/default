...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 20: If you accidentally spill a chemical, an SDS will tell you how to clean it up.') }}</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz21" class="btn btn-primary btn-block">Next Question</a>
