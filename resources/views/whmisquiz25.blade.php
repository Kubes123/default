...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 25: What Pictogram is this:') }}</div>

                    <div class="flex row justify-content-center pt-8 sm:justify-start sm:pt-0">
                        <img src={{asset('pictogram/exclamationmark.gif')}} alt="Logo" height="200" style="padding-top: 21px">
                    </div>
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Toxic or poisonous</b></a>
                                    
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Explosive or Highly Reactive</b></a>

                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Gas Under Pressure</b></a>
 
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal"
                                    > <b style="color:white;">Irritant if touched, inhaled or ingested</b></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    {{-- <div>
                                        ...
                                        <a href="54uhers/{{ Auth::user()->id }}" class="btn btn-primary btn-block">Next Question</a>
                                    </div> --}}
                                    ...
                                    <div>
                                        <form method="post" action="{{url('sendemail/send')}}">
                                            ...
                                            <div class="form-group">
                                                <input type="hidden" name="message" class="form-control" value="WHMIS" />
                                            </div>
