...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 3: Chemicals can be:') }}</div>

                <div class="card-body">
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Solids</b></a>
                                    
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Liquids</b></a>

                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Gases</b></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz4" class="btn btn-primary btn-block">Next Question</a>
