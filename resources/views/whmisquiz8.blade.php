...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 8: A suppler label will contain:') }}</div>

                <div class="card-body">
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal"
                                    > <b style="color:white;">a)	Pictogram</b></a>
                                    
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">b)	Responsibilities</b></a>

                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">c)	Legal Disclaimer</b></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz9" class="btn btn-primary btn-block">Next Question</a>
