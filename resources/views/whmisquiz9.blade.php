...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('QUESTION 9: A workplace label will contain:') }}</div>

                <div class="card-body">
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Pictogram</b></a>
                                    
                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal"
                                    > <b style="color:white;">Safe Use Precautions</b></a>

                    <a class="btn btn-info btn-block" data-toggle="modal" data-target="#smallModal2"
                                    > <b style="color:white;">Supplier Identifier</b></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="smallBody">
                                    <div>
                                        ...
                                        <a href="whmisquiz10" class="btn btn-primary btn-block">Next Question</a>
